...
use Rajib\LaravelCountryStateCity\Models\Country;
...
class CountryTableSeeder extends Seeder
{
    ...
    private function countries(){
        return $countries = array(
            array("id"=> 1, "name"=> "Afghanistan", "iso3"=> "AFG", "iso2"=> "AF", "phone_code"=> "93", "capital"=> "Kabul", "currency"=> "AFN", "currency_symbol"=> "؋", "tld"=> ".af", "native"=> "افغانستان", "region"=> "Asia", "subregion"=> "Southern Asia", "latitude"=> "33.00000000", "longitude"=> "65.00000000", "emoji"=> "🇦🇫", "emojiU"=> "U+1F1E6 U+1F1EB"),
            array("id"=> 2, "name"=> "Aland Islands", "iso3"=> "ALA", "iso2"=> "AX", "phone_code"=> "+358-18", "capital"=> "Mariehamn", "currency"=> "EUR", "currency_symbol"=> "€", "tld"=> ".ax", "native"=> "Åland", "region"=> "Europe", "subregion"=> "Northern Europe", "latitude"=> "60.11666700", "longitude"=> "19.90000000", "emoji"=> "🇦🇽", "emojiU"=> "U+1F1E6 U+1F1FD"),
            array(
              "id"=> 3,
              "name"=> "Albania",
              "iso3"=> "ALB",
            ...
            array("id"=> 247, "name"=> "Zimbabwe", "iso3"=> "ZWE", "iso2"=> "ZW", "phone_code"=> "263", "capital"=> "Harare", "currency"=> "ZWL", "currency_symbol"=> "$", "tld"=> ".zw", "native"=> "Zimbabwe", "region"=> "Africa", "subregion"=> "Eastern Africa", "latitude"=> "-20.00000000", "longitude"=> "30.00000000", "emoji"=> "🇿🇼", "emojiU"=> "U+1F1FF U+1F1FC")
        );
